...
import 'circle_menu_painter.dart';
...
class _CoundownState extends State<CircleMenu> {
  ...
  Widget build(BuildContext context) {
    final menuItems = List.generate(widget.icons.length,
        (index) => MenuItem(widget.icons[index], "icon$index"));
      ...
      child: Container(
        child: CustomPaint(
          ...
          painter: CircleMenuPainter(
            ...
            shouldDraw: _isMoving,
            icons: menuItems,
            selectedMenuPoint: _menuSelectedPoint,
